...
def audio_stream(queue: mp.Queue):
    ...
    streamer = StreamReader(src="audio=@device_cm_{33D9A762-90C8-11D0-BD43-00A0C911CE86}\wave_{A5B93F21-D45A-4BB7-B942-66001F04F2DE}", format="dshow")
